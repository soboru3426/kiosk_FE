document.addEventListener("DOMContentLoaded", function() {
    ...
    // 주문 데이터 배열에서 totalPrice 값만 추출
    let selectedMenuPrice = cartOrders.map(order => order.totalPrice || 0);
    ...
    console.log("Selected menu prices (totalPrice only):", selectedMenuPrice);
